...
const Navbar = () => {
        ...
        if (password !== confirmPassword) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    setshowModaRegistration(!showModaRegistration);
    ...
    return (
        <>
            ...
            <div className={`bg-gray-800  text-white md:hidden shadow-xl min-w-[150px] space-y-4 z-50 p-3 rounded-md text-right  fixed ${isMenuOpen ? "block  top-15 right-10 " : "hidden"}`}>
                {
                    <div className=' flex flex-col items-center'>
                        <ul className=' flex flex-col  z-40  '>
                            {
                                navItems.map(({ link, path }) => <a key={link} href={path} className='text-center text-base hover:text-gray-300 z-[1000px] '>{link}</a>)
                            }
                        </ul>
                        ...
                        {
                            token ?
                                <div className=' mt-2'> <Deshboard data={user} /></div> : <>
                                    <a href='#login' className=' flex items-center mt-5' onClick={() => setshowModalLogin(true)}><FaCircleUser /> <span className='px-1'>Login</span></a>
                                    <a href='#registration' onClick={() => setshowModaRegistration(true)}><button className=''>Registration</button></a>
                                </>
                        }
            ...
            {showModalLogin ? (
                <>
                    <div className="flex justify-center items-center overflow-x-hidden  fixed inset-0 z-50 outline-none focus:outline-none bg-black/60">
                        <div class="relative w-full max-w-md px-4 h-auto">
                            <div class="bg-white rounded-lg shadow relative dark:bg-gray-700">
                                ...
                                <form onSubmit={Login} class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="#">
                                    ...
                                    <div>
                                        <label for="newpassword" class="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Password</label>
            ...
            {showModaRegistration ? (
                <>
                    <div className="flex justify-center bg-black/40 items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                        <div class="relative w-full max-w-md px-4 h-full md:h-auto">
                            <div class="bg-white rounded-lg  relative dark:bg-gray-700">
                                <div class="flex justify-end p-2">
                                ...
                                <form onSubmit={Registration} class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="#">
                                    ...
                                    <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                                        Registered ? <a href="#login" onClick={() => setshowModalLogin(true) & setshowModaRegistration(false)} class="text-blue-700 hover:underline dark:text-blue-500">Login</a>
                                    </div>
                                </form>
                            </div>
                        </div>
